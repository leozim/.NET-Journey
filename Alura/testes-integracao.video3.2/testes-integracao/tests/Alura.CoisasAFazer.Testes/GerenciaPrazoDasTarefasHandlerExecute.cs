...
namespace Alura.CoisasAFazer.Testes
{
    public class GerenciaPrazoDasTarefasHandlerExecute
    {
        ...
        [Fact]
        public void VerificaQuantasVezesAtualizarTarefasFoiChamado()
        {
            //arrange
            var categoria = new Categoria("Dummy");
            var tarefas = new List<Tarefa>
            {
                new Tarefa(100, "Tirar lixo", categoria, new DateTime(2018,12,31), null, StatusTarefa.Criada),
                new Tarefa(100, "Jogar o lixo na rua", categoria, new DateTime(2018,12,31), null, StatusTarefa.Criada),
                new Tarefa(100, "Deixar o lixo apodrecer com mau cheiro pra depois jogar na rua", categoria, new DateTime(2018,12,31), null, StatusTarefa.Criada)
            };
